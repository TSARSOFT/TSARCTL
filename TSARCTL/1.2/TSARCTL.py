...
def check_connection(host="8.8.8.8", port=53, timeout=5):
  try:
...
File.add_command(label='Close', command=lambda:closewin())
...
lightslider.set(get_brightness())
